...
public class SequenceDatabase{
    ...
    //I add this function to deal with memory read
    public double loadFile(ArrayList<String> stringList, double minSupport) throws IOException {
        String thisLine;
            //For each line
            for (int i=0; i<stringList.size();i++) {
                // If the line is not a comment line
            	thisLine = stringList.get(i);
