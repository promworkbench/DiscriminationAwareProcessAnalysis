...
public abstract class Classifier
  ...
  //change 1
  protected static boolean m_SaAbsent=false;
  public static boolean m_SaRemove=true;
...
//----------------------------change-----------------------------
 ...
 //------------------------------end-------------------------------------
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
	      "\tIf set, Sensitive Attribute will only be used\n"
	      + "\t in learning phase, not at prediction time",
	      "Z", 0, "-Z"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    //setSaAbsent(Utils.getFlag('Z', options));
  }
...
while (current < options.length) {
  ...
  public void  setSaAbsent(boolean s){
      J48WithNDCs j1=new J48WithNDCs();
      // J48 j1=new J48();
      if(!s)
         j1.setrelabel(false);
         m_SaAbsent=s;
         //Discrimination.setSAA(s);
      if(m_SaRemove && s)
          Discrimination.setSAA(true);
      else
  ...
  public String saAbsentTipText(){
      return "If set, Sensitive Attribute will only be used" +
              " in learning phase, not at prediction time.";
  }
}
