	...
	while (enumAtts.hasMoreElements()) {
	  ...
	  if (!instance.isMissing(attribute)) {
		...
		[(int)instance.value(attribute)]+=instance.weight();
              //System.out.println(" weigth   "+instance.weight());
	    } else {
	      m_Means[(int)instance.classValue()][attIndex] +=
		instance.value(attribute)*instance.weight();
	      m_Counts[(int)instance.classValue()][attIndex][0]+=instance.weight();
              //System.out.println(" weigth   "+instance.weight());
	    }
	  }
	  attIndex++;
...
/*
 String sav=instance.toString(Discrimination.getSaIndex());
 System.out.println(" prob of DC = "+probs[Discrimination.getDC()]+"\t prob of NDC = "+probs[Discrimination.getNDC()]);
     if(sav.equals(Discrimination.getSaDep()))
     {
           probs[Discrimination.getDC()]+=.2;
           //probs[Discrimination.getNDC()]-=0.2;
     }
     else{
         probs[Discrimination.getDC()]-=0.2;
         //probs[Discrimination.getNDC()]+=0.2;
     }
 System.out.println("  prob of DC = "+probs[Discrimination.getDC()]+"\t prob of NDC = "+probs[Discrimination.getNDC()]);
  Utils.normalize(probs);
  System.out.println("Normalized prob of DC = "+probs[Discrimination.getDC()]+"\t prob of NDC = "+probs[Discrimination.getNDC()]);*/
