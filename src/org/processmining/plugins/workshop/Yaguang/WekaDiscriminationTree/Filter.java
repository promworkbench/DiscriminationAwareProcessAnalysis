...
public abstract class Filter implements Serializable {
  ...
  protected void bufferInput(Instance instance) {
   ...
   // System.out.println("bufferInput method : filter class");
  }
  ...
  public boolean input(Instance instance) throws Exception {
   ...
   // System.out.println("input method : filter class");
    return false;
  }
  ...
  public static Instances useFilter(Instances data,
   ...
   for (int i = 0; i < data.numInstances(); i++) {
      filter.input(data.instance(i));
      //System.out.println("use filter : filter class");
    }
    filter.batchFinished();
